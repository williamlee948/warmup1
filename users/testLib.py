...
class RestTestCase(unittest.TestCase):
    ...
    serverToTest = "mighty-waters-5495.herokuapp.com"
    ...
    def makeRequest(self, url, method="GET", data=None):
        ...
        try:
            ...
            print "Got exception when processing response to url="+RestTestCase.serverToTest+url+" method="+method+" data="+str(data)
